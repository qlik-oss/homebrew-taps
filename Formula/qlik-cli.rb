...
class QlikCli < Formula
  ...
  on_macos do
    url "https://github.com/qlik-trial/qlik-cli/releases/download/v2.26.0/qlik-Darwin-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://github.com/qlik-trial/qlik-cli/releases/download/v2.26.0/qlik-Linux-x86_64.tar.gz"
