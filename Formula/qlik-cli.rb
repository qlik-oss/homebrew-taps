...
class QlikCli < Formula
  ...
  on_macos do
    url "https://raw.githubusercontent.com/qlik-oss/homebrew-taps/master/bin/qlik-cli/v2.14.3/qlik-Darwin-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://raw.githubusercontent.com/qlik-oss/homebrew-taps/master/bin/qlik-cli/v2.14.3/qlik-Linux-x86_64.tar.gz"
