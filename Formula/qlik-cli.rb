...
class QlikCli < Formula
  ...
  on_macos do
    if Hardware::CPU.intel?
      url "https://raw.githubusercontent.com/qlik-oss/homebrew-taps/master/bin/qlik-cli/v2.3.1/qlik-Darwin-x86_64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.intel?
      url "https://raw.githubusercontent.com/qlik-oss/homebrew-taps/master/bin/qlik-cli/v2.3.1/qlik-Linux-x86_64.tar.gz"
